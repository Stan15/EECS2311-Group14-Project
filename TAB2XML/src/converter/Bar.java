...
public class Bar {
	...
	public Bar(String s) { //bar into string
		...
		Info = new ArrayList<String>(); //stores entire info of each bar
		...
		ArrayList<String> temp = new ArrayList<String>(); //gets the info from each line and storing into a string, added into 'info'
